...
public class SamplesCommon {
	 ...
	 */	
	public static NurApiTransport createTransport(String host, int port) {
	...
	public static NurApi createAndConnectNurApi(String host, int port) throws Exception
	{
		// Create a new NurApi object
		NurApi api = createNurApi();
		try {			
			// Set transport for NurApi
			api.setTransport(SamplesCommon.createTransport(host, port));
